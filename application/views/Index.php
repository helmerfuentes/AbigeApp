...
<head>
    ...
    <!-- //Custom Theme files -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/Fron-end//views/css/bootstrap.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/Fron-end//views/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/Fron-end//views/css/swipebox.css">
   
    <!-- js -->
  
    <script src="<?php echo base_url();?>assets/Fron-end/views/js/jquery-1.11.1.min.js"></script>
    <!-- //js -->
    <!--web-fonts-->
    ...
    <script src="<?php echo base_url();?>assets/Fron-end/views/js/move-top.js"></script>
    <script src="<?php echo base_url();?>assets/Fron-end/views/js/easing.js"></script>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="hvr-bounce-to-bottom" style="text-decoration:none;background:#ffff;">
                        
                        <div style="color:red; background:#ffff;">
                       
                        <form action="<?php echo base_url();?>Sesion/login" method="post"> <table>
                        <tr>
                        <td><input type="text" class="form-control" placeholder="Correo" name="correo" id="correo"></td>
                        <td><input type="password" class="form-control" placeholder="Password" name="password" id="password"></td>
                        <td> <div class="col-sm-12">
                                    <button type="submit" class="btn btn-success"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ingresar</font></font></button>
                                </div></td>
                        </tr>
                        </table>
    ...
    <div class="banner">
        ...
        <div class="banner-text">
            ...
            <script src="<?php echo base_url();?>assets/Fron-end/views/js/responsiveslides.min.js"></script>
            ...
            <div class="modal-content">
                ...
                <section>
                    <div class="modal-body modal-spa">
                        ...
                        <img class="img-responsive" src="<?php echo base_url();?>assets/Fron-end/views/images/img1.jpg" alt="">
    ...
    <div class="modal bnr-modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <section>
                    <div class="modal-body modal-spa">
                    <img class="img-responsive" src="<?php echo base_url();?>assets/Fron-end/views/images/cowsfiltro.png" alt="">
    ...
    <div class="features">
        <div class="container">
            ...
            <div class="col-md-6 features-left">
                ...
                <!--modal-video-->
                <div class="modal video-modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <!--bar-js-->
            <script src="<?php echo base_url();?>assets/Fron-end/views/js/bars.js"></script>
